            ...
            <section>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p id='uidnote' className={userFocus && user && !validName ? 'instructions' : 'offscreen'}><FontAwesomeIcon icon={faInfoCircle} />4 to 24 Characters <br />
                        ...
                        Letters,numbers,hyphens and underscores allowed</p>
                    ...
                    <p id='pwdnote' className={pwdFocus && pwd && !validPwd ? 'instructions' : 'offscreen'}><FontAwesomeIcon icon={faInfoCircle} />8 to 24 Characters <br />
                        ...
                        <span aria-label='dollar sign'>$</span><span aria-label='percent'>%</span></p>
                    ...
                    <p id='confirmnote' className={matchPwdFocus && matchPwd && !validMatch ? 'instructions' : 'offscreen'}><FontAwesomeIcon icon={faInfoCircle} />Must match the first password input field</p>
                    <button disabled={!validName || !validMatch || !validPwd ? true : false}>Sign Up</button>
                </form>
                <p>Already registered?<br /><span className="line">
                    {/*Put router link here*/}
                    <a href='#'>SIgn In</a></span></p>
            </section>)}</>
    )
}
